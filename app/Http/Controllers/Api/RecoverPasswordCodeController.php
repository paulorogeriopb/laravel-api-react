...
class RecoverPasswordCodeController extends Controller
{
    ...
    public function forgotPasswordCode(ForgotPasswordRequest $request): JsonResponse
    {
        ...
        try {
            ...
            // Salvar log
            Log::warning('Erro recuperar senha.', ['email' => $request->email, 'error' => $th->getMessage()]);
    ...
    public function resetPasswordValidateCode(ResetPasswordValidateCodeRequest $request, ResetPasswordValidateCodeService $resetPasswordValidateCode)
    {
        ...
        try{
            ...
            // Salvar log
            Log::warning('Erro validar código recuperar senha.', ['email' => $request->email, 'error' => $th->getMessage()]);
